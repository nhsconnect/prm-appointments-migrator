...
UPDATE medication_statements SET medicationRequestId = 20 WHERE id = 1;
UPDATE medication_statements SET medicationRequestId = 32 WHERE id = 9;
UPDATE medication_statements SET medicationRequestId = 44 WHERE id = 10;
UPDATE medication_statements SET medicationRequestId = 56 WHERE id = 11;
UPDATE medication_statements SET medicationRequestId = 68 WHERE id = 12;
